...
Pre-processed AVC file provided: '../testfiles/file_context_AVC.log'
...
Pre-processed AVC file provided: '../testfiles/network_AVC.log'
...
Pre-processed AVC file provided: '../testfiles/multi_AVC.log'

Found 4 AVC events. Displaying 2 unique denials...
───────────────────────────────────────────────────────────────────── Parsed Log Summary ─────────────────────────────────────────────────────────────────────
───────────────────────────────────────────────── Unique Denial #1 (2 occurrences, last seen 1 hour(s) ago) ──────────────────────────────────────────────────
...
-----------------------------------
──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
───────────────────────────────────────────────── Unique Denial #2 (1 occurrences, last seen 1 hour(s) ago) ──────────────────────────────────────────────────
...
Note: The following record types were found in the log but are not currently parsed:
  USER_ACCT
```
...
```shell
$ sudo ausearch -m AVC -if ../testfiles/audit.log | grep AVC -c
74
$ sudo ausearch -m AVC -if ../testfiles/audit.log | grep AVC | grep pulpcore-worker -c
74
$ sudo ausearch -m AVC -if ../testfiles/audit.log | grep AVC | grep pulpcore | awk '{print $1=$2=$8=$9="",$0}' | sort -u
...
$ python parse_avc.py -rf ../testfiles/audit.log
Raw file input provided. Running ausearch on '../testfiles/audit.log'...
